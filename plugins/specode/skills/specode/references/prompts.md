...
```text
sh ${CLAUDE_PLUGIN_ROOT}/scripts/run.sh ${CLAUDE_PLUGIN_ROOT}/scripts/spec_choice.py --title "<标题以问号结尾？>" \
...
```text
sh ${CLAUDE_PLUGIN_ROOT}/scripts/run.sh ${CLAUDE_PLUGIN_ROOT}/scripts/spec_choice.py --title "选择 spec 工作流类型？" \
...
```text
sh ${CLAUDE_PLUGIN_ROOT}/scripts/run.sh ${CLAUDE_PLUGIN_ROOT}/scripts/spec_choice.py --title "确认 <filename>？" \
...
```text
sh ${CLAUDE_PLUGIN_ROOT}/scripts/run.sh ${CLAUDE_PLUGIN_ROOT}/scripts/spec_choice.py --title "是否开始执行 tasks？" \
...
```text
sh ${CLAUDE_PLUGIN_ROOT}/scripts/run.sh ${CLAUDE_PLUGIN_ROOT}/scripts/spec_choice.py --title "spec 已被 session <holder> 锁定，如何继续？" \
...
```text
sh ${CLAUDE_PLUGIN_ROOT}/scripts/run.sh ${CLAUDE_PLUGIN_ROOT}/scripts/spec_choice.py --title "需求澄清是否完成？" \
...
```text
sh ${CLAUDE_PLUGIN_ROOT}/scripts/run.sh ${CLAUDE_PLUGIN_ROOT}/scripts/spec_choice.py --title "本轮验收是否通过？" \
